...
//	debuglog("BackendCoinPayments $coin->symbol");
	...
	if($coin->symbol == 'BTC' || $coin->symbol == 'LTC' || $coin->symbol == 'IFC' || $coin->symbol == 'BITC' || $coin->symbol == 'BNODE' || $coin->symbol == 'BOD' || $coin->symbol == 'DIME' || $coin->symbol == 'BTCRY' || $coin->symbol == 'IOTS' || $coin->symbol == 'ECC' || $coin->symbol == 'ADOT' || $coin->symbol == 'SAPP' || $coin->symbol == 'CURVE' || $coin->symbol == 'CBE' || !empty($coin->payout_max))
	{
